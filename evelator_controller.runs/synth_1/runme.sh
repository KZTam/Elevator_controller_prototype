...
HD_PWD='C:/Users/tamka/OneDrive/Documents/Vivado_projects/evelator_controller/evelator_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elevator_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elevator_controller.tcl
