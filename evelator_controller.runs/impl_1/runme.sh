...
HD_PWD='C:/Users/tamka/OneDrive/Documents/Vivado_projects/evelator_controller/evelator_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log elevator_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source elevator_controller.tcl -notrace
